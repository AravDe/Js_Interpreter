...
Purpose:    Create a class for stacks with basic stack operations

History:
            2024-12-21, DMW, added __str__ method; pretty_print method;
...
class Stack:
    ...
    # 2024-12-21, DMW, added this method
    def __str__(self) -> str:
        return str(self.stack)

    # 2024-12-21, DMW, added pretty print method
    def pretty_print(self) -> str:
        ...
        if stack_len == 0:
            ...
            for i in range(stack_len):
                output += "{}: ({}) {}\n".format(stack_len - i, Common.object_type(self.stack[i]), self.stack[i])
        return output
    ...
    # for internal use by class Stack, can check any depth, defaults to TOS
...
if __name__ == "__main__":
    ...
    x.make_list()
    x.push(17)
    x.push({"key1": "value1", "key2": "value2"})
    # print(x.stack)
    print(x)
